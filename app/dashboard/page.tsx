      ...
      >
        ...
        <div className="absolute top-0 right-0 px-4 pt-12">
          {editingCover ? (
            ...
            <button onClick={() => signOut({ callbackUrl: "/login" })} className="text-white/60 w-8 h-8 flex items-center justify-center rounded-full bg-black/30 backdrop-blur-sm" title="Đăng xuất">
